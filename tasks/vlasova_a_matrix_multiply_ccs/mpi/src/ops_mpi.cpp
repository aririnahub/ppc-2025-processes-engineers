...
namespace vlasova_a_matrix_multiply_ccs {
  ...
  void VlasovaAMatrixMultiplyMPI::multiplyLocalMatrices(const SparseMatrixCCS& AT,
  ...
  bool VlasovaAMatrixMultiplyMPI::RunImpl() {
      ...
      multiplyLocalMatrices(AT, loc_B_val, loc_B_row_ind, loc_B_col_ptr, loc_cols,
                          loc_res_val, loc_res_row_ind, loc_res_col_ptr);
